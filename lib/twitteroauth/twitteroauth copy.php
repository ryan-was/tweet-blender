...
$OAuth = str_ireplace('tweet-blender/lib/twitteroauth','wordpress-social-login/hybridauth/Hybrid/thirdparty/OAuth',$thisDir).'/OAuth.php';
class_exists("OAuthSignatureMethod_HMAC_SHA1") && class_exists("OAuthSignatureMethod_RSA_SHA1") || require_once($OAuth);
/**
 * Twitter OAuth class
 */
class TwitterOAuth {
