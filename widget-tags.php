...
class TweetBlenderForTags extends WP_Widget {
    ...
    private $maxTime =  3600; // 30min old
    ...
    function widget($args, $instance) {
        ...
        $instance['widget_sources'] = implode('\n\r',$sources);
        ...
        echo '<input type="hidden" name="sources" value="' . addslashes(implode(',',$sources)) . '">';
        ...
        // WAS : update here to avoid caching of page
        echo tb_create_markup($mode = 'widget',$instance,$this->id,$tb_o,$noLoadTweets);
